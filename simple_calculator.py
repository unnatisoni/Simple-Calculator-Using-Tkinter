...
e.grid(row=0,column=0,columnspan=500,padx=10,pady=10)
...
button_subtract=Button(root,text="-",padx=40,pady=30,command=button_subtract)
button_divide=Button(root,text="//",padx=40,pady=30,command=button_divide)
button_multiply=Button(root,text="X",padx=40,pady=30,command=button_multiply)
button_equal=Button(root,text="=",padx=40,pady=30,command=button_equal)
button_clear=Button(root,text="clear",padx=30,pady=30,command=button_clear)
